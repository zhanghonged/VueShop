...
class GoodsCategory(models.Model):
    ...
    category_type = models.CharField(max_length=100, choices=CATEGORY_TYPE, verbose_name="类目级别", help_text="类目级别")
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    cagetory = models.ForeignKey(GoodsCategory, null=True, blank=True, verbose_name="商品类别", on_delete=models.CASCADE)
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name="内容", imagePath="goods/images/", width=1000, height=300,
                              help_text="",filePath="goods/files/",default="")
